...
svm = SVM()
train_time, iters = svm.fit(x_train57, y_train57)
...
print(f'Optimization solver: Default CVXOPT solver')
print(f'Function evaluations: {iters}')
print(f'Gradient evaluations: {iters}')
